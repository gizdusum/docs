...
If your app creates transactions with large gas limits, we recommend monitoring to detect any changes in inclusion latency. Transactions with gas limits over 1/10 of the current block gas limit (block gas limit currently at 187.5 million gas as of Jan 21, 2026), face additional constraints:
