...
[ Code](https://docs..com/en/docs/-code/overview) is an agentic coding tool that lives in your terminal and understands your codebase.
...
<Steps>
  ...
  <Step title="Reference in chat">
    Use the `/read` command or drag and drop the file path to include the documentation in your conversation.  Code will then have access to the full Base documentation for that session.
  </Step>
</Steps>
