...
#### Will Farcaster be needed at a later point

If no → Use SIWE as primary, and ask users to connect SIWF only when needed.

If yes → Use SIWF as primary, with SIWE optional for wallet-based identity or payments.
